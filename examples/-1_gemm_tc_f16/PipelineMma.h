...
class PipelinedMma{
    ...
    using WarpCount = cutlass::gemm::GemmShape<TBShape::kM / Policy::Operator::Shape::kM,           //WShape * 3
    ...
    static int const kWarpGemmIterations =  (Policy::Operator::Shape::kK / Operator::Policy::MmaShape::kK);                 //8
    public:
    CUTLASS_DEVICE
    PipelinedMma(
        ...
        int N = TBShape::kN / Policy::Operator::Shape::kN, M = TBShape::kM / Policy::Operator::Shape::kM;           //tbM / wM,  tbN / wN
        int NM = N * M;                                                                                             //8,  4
        int warp_idx_nm = warp_idx % NM, warp_idx_k = warp_idx / NM;
        #define warp_idx_n (warp_idx_nm / M)
        #define warp_idx_m  (warp_idx_nm % M)
